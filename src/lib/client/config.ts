...
export const SKINS: ReadonlyArray<SkinDefinition> = [
  { id: "green", body: 0x86d94e, dark: 0x4c9a33, light: 0xd0f5a8, minimap: "#86d94e", headTexture: "/assets/sprites/head-green.png" },
  { id: "blue", body: 0x4db8f0, dark: 0x2a6fb8, light: 0xb3e2fa, minimap: "#4db8f0", headTexture: "/assets/sprites/head-blue.png" },
  { id: "purple", body: 0xa86ef0, dark: 0x6a3ab8, light: 0xdcc4fa, minimap: "#a86ef0", headTexture: "/assets/sprites/head-purple.png" },
  { id: "orange", body: 0xf5a53c, dark: 0xc06a1d, light: 0xfad6a0, minimap: "#f5a53c", headTexture: "/assets/sprites/head-orange.png" },
  { id: "red", body: 0xf26d5f, dark: 0xb83a2e, light: 0xfabcb3, minimap: "#f26d5f", headTexture: "/assets/sprites/head-red.png" },
];
