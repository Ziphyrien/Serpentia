<script lang="ts">
  ...
  const buttonClass = $derived.by(() => {
    if (!boosting) return "border-white/25 bg-amber-300/90 text-night-950";
    if (!canBoost) return "scale-95 border-white/15 bg-white/10 text-white/50";
    return "scale-95 border-amber-200 bg-amber-400 text-night-950 shadow-[0_0_30px_rgba(251,191,36,0.6)]";
  });
